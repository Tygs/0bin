...
/* custom */
(function(){sjcl.random.startCollectors();$.ajaxSetup({cache:true});function a(c){var b=arguments;return function(){return c.apply(c,Array.prototype.slice.call(b,1))}}window.zerobin={version:"0.1.1",encrypt:function(f,g,d,b,e,c){setTimeout(function(){g=sjcl.codec.utf8String.toBits(g);if(d){d()}setTimeout(function(){g=sjcl.codec.base64.fromBits(g);if(b){b()}setTimeout(function(){if(e){e()}setTimeout(function(){try{g=sjcl.encrypt(f,g)}catch(h){$("input, textarea, select, button").prop("disabled",false);zerobin.progressBar("form.well .progress").container.hide();zerobin.message("error","Paste could not be encrypted. Aborting.","Error")}if(c){c(g)}},250)},250)},250)},250)},decrypt:function(f,g,d,b,e,h,c){setTimeout(function(){try{g=sjcl.decrypt(f,g);if(b){b()}setTimeout(function(){try{g=lzw.decompress(g);if(e){e()}setTimeout(function(){try{g=sjcl.codec.base64.toBits(g);if(h){h()}setTimeout(function(){try{g=sjcl.codec.utf8String.fromBits(g);if(c){c(g)}}catch(l){d(l)}},250)}catch(k){d(k)}},250)}catch(j){d(j)}},250)}catch(i){d(i)}},250)},makeKey:function(){return sjcl.codec.base64.fromBits(sjcl.random.randomWords(8,0),0)},getFormatedDate:function(b){b=b||new Date();return((b.getMonth()+1)+"-"+b.getDate()+"-"+b.getFullYear())},getFormatedTime:function(c){c=c||new Date();var e=c.getHours(),b=c.getMinutes(),d=c.getSeconds();if(e<10){e="0"+e}if(b<10){b="0"+b}if(d<10){d="0"+d}return e+":"+b+":"+d},numOrdA:function(d,c){return(d-c)},getLocalStorageKeys:function(){var b="zerobinV0.1";var d=[];for(var c in localStorage){if(c.indexOf(b)!==-1){d.push(c)}}d.sort();d.reverse();return d},getTinyURL:function(d,c){var b="http://is.gd/create.php?format=json&url=";$.getJSON(b+encodeURIComponent(d)+"&callback=?",function(e){c(e.shorturl)})},support:{localStorage:(function(){var b=!!(localStorage);$("html").addClass((b?"":"no-")+"local-storage");return b})(),history:(function(){var b=!!(window.history&&history.pushState);$("html").addClass((b?"":"no-")+"history");return b})(),fileUpload:(function(){var b=window;var c=!!(b.File&&b.FileReader&&b.FileList&&b.Blob);$("html").addClass((c?"":"no-")+"file-upload");return c})()},storePaste:function(c,b){b=b||new Date();b=(b.getFullYear()+"-"+(b.getMonth()+1)+"-"+b.getDate()+" "+zerobin.getFormatedTime(b));var d=zerobin.getLocalStorageKeys();if(localStorage.length>19){void localStorage.removeItem(d[19])}localStorage.setItem("zerobinV"+zerobin.version+"#"+b,c)},getPreviousPastes:function(){var c=[],d=zerobin.getLocalStorageKeys(),b=zerobin.getFormatedDate();$.each(d,function(g,f){var j=f.replace(/^[^#]+#/,"");var e=j.match(/^(\d+)-(\d+)-(\d+)\s/);e=e[2]+"-"+e[3]+"-"+e[1];var h="the ";if(e===b){e=j.split(" ")[1];h="at "}c.push({displayDate:e,prefix:h,link:localStorage.getItem(f)})});return c},parseUrl:(function(){var b=document.createElement("div");b.innerHTML="<a></a>";return function(c){b.firstChild.href=c;b.innerHTML=b.innerHTML;return b.firstChild}})(),getPasteId:function(b){var c=b?zerobin.parseUrl(b):window.location;return c.pathname.replace(/\/|paste/g,"")},getPasteKey:function(b){var c=b?zerobin.parseUrl(b):window.location;return c.hash.replace("#","").replace(/(\?|&).*$/,"")},getPasteContent:function(){var b="";$("#paste-content li").each(function(c){b=b+$(this).text().replace(/[\u00a0]+/g," ")+"\n"});return b},count:function(h,d){var g=/(\r?\n|\r)/g;var c=/(\r?\n|\r|\s+)/g;d=d||{};d.lineBreaks=d.lineBreaks||1;var f=h.length,e=f-h.replace(/[\u0100-\uFFFF]/g,"").length,b=f-h.replace(g,"").length;return f+e+Math.max(0,d.lineBreaks*(b-1))},message:function(d,e,f,b,g){$(window).scrollTop(0);if(b){$(".alert-"+d).remove()}var c=$("#alert-template").clone().attr("id",null).addClass("alert alert-"+d);$(".message",c).html(e);if(f){$(".title",c).html(f)}else{$(".title",c).remove()}c.prependTo($("#main")).show("fadeUp",g)},progressBar:function(b){var d=$(b);var c={container:d,elem:d.find(".bar")};c.set=function(f,e){c.elem.text(f).css("width",e)};return c},isCode:function(j){var c=/[A-Z]{3}[A-Z]+|\.[a-z]|[=:<>{}\[\]$_'"&]| {2}|\t/g;var f=/(:?\/\*|<!--)(:?.|\n)*?(:?\*\/|-->)|(\/\/|#)(.*?)\n/g;var h=/[-*=_+]{4,}/;var g=0;var l=0;var b=j.match(f);if(b){g+=j.match(f).length}j=j.replace(f,"");j.replace(h,"");j=j.split("\n");for(var d=0;d<j.length;d++){var k=j[d];l+=k.length;var e=k.replace(h,"").match(c);if(e){g+=e.length}}return g*1000/l},ignoreDrag:function(b){b.originalEvent.stopPropagation();b.originalEvent.preventDefault()},handleDrop:function(b){zerobin.ignoreDrag(b);zerobin.upload(b.originalEvent.dataTransfer.files);$("#content").removeClass("hover")},handleDragOver:function(b){zerobin.ignoreDrag(b);$(this).addClass("hover")},handleDragLeave:function(b){zerobin.ignoreDrag(b);$(this).removeClass("hover")},upload:function(d){var c=d[0];var b=new FileReader();if(c.type.indexOf("image")==0){b.onload=function(e){var f=new Image();f.src=e.target.result;f.onload=function(){var l=1024,k=1024,i=f.width,g=f.height;if(i>g){if(i>l){g*=l/i;i=l}}else{if(g>k){i*=k/g;g=k}}var j=document.createElement("canvas");j.width=i;j.height=g;f.width=i;f.height=g;var h=j.getContext("2d");h.drawImage(this,0,0,i,g);var m=j.toDataURL(c.type);$("#content").val(m).trigger("change");$("#content").hide();$(f).css("max-width","742px");$("#content").after(f)}};b.readAsDataURL(c)}else{b.onload=function(e){$("#content").val(e.target.result).trigger("change")};b.readAsText(c)}}};$(function(){$(".btn-primary").live("click",function(v){v.preventDefault();var u=$("textarea").val();if(u.trim()){var q=$("input, textarea, select, button").prop("disabled",true);var t=zerobin.progressBar("form.well .progress");t.container.show();t.set("Converting paste to bits...","25%");try{var p=$("#expiration").val();var r=zerobin.makeKey();zerobin.encrypt(r,u,a(t.set,"Encoding to base64...","45%"),a(t.set,"Compressing...","65%"),a(t.set,"Encrypting...","85%"),function(w){t.set("Sending...","95%");var y={content:w,expiration:p};var A=zerobin.count(JSON.stringify(y));var z=A>zerobin.max_size;var e=Math.round(A/1024);var x=Math.round(zerobin.max_size/1024);if(z){t.container.hide();q.prop("disabled",false);zerobin.message("error",('The encrypted file was <strong class="file-size">'+e+"</strong>KB. You have reached the maximum size limit of "+x+"KB."),"Warning!",true);return}$.post("/paste/create",y).error(function(B){q.prop("disabled",false);t.container.hide();zerobin.message("error","Paste could not be saved. Please try again later.","Error")}).success(function(C){t.set("Redirecting to new paste...","100%");if(C.status==="error"){zerobin.message("error",C.message,"Error");q.prop("disabled",false);t.container.hide()}else{var B="/paste/"+C.paste+"#"+r;if(zerobin.support.localStorage){zerobin.storePaste(B)}window.location=(B)}})})}catch(s){q.prop("disabled",false);t.container.hide();zerobin.message("error","Paste could not be encrypted. Aborting.","Error")}}});var h=$("#paste-content").text().trim();var k=zerobin.getPasteKey();var j=false;if(h&&k){$.getScript("/static/js/vizhash.min.js").done(function(p,q){if(vizhash.supportCanvas){var e=vizhash.canvasHash(zerobin.getPasteId(),24,24);$('<a class="vhash" href="#"></a>').click(function(r){r.preventDefault();if(confirm("This picture is unique to your paste so you can identify it quickly. \n\n Do you want to know more about this?")){window.open("http://is.gd/IJaMRG","_blank")}}).prependTo(".lnk-option").append(e.canvas)}});var n=$("input, textarea, select, button").prop("disabled",true);var i=zerobin.progressBar(".well form .progress");i.container.show();i.set("Decrypting paste...","25%");zerobin.decrypt(k,h,function(){i.container.hide();zerobin.message("error","Could not decrypt data (Wrong key ?)","Error")},a(i.set,"Decompressing...","45%"),a(i.set,"Base64 decoding...","65%"),a(i.set,"From bits to string...","85%"),function(q){$("#paste-content").text(q);if(q.indexOf("data:image")==0){$("#paste-content").hide();var e=$("<img/>");$(e).attr("src",q);$(e).css("max-width","742px");$("#paste-content").after(e);$(".btn-clone").hide();var p=$("<a/>").attr("href",q);$(p).attr("download","0bin_"+document.location.pathname.split("/").pop());$(p).addClass("btn");$(p).html('<i class="icon-download"></i> Download');$(".btn-clone").after(p)}i.set("Code coloration...","95%");setTimeout(function(){ZeroClipboard.setMoviePath("/static/js/ZeroClipboard.swf");var s=new ZeroClipboard.Client();var r=function(){s.reposition()};s.addEventListener("mouseup",function(){$("#clip-button").text("Copying paste...");s.setText(zerobin.getPasteContent())});s.addEventListener("complete",function(){$("#clip-button").text("Copy to clipboard");zerobin.message("info","The paste is now in your clipboard","",true,r)});s.glue("clip-button");window.onresize=r;$("#short-url").click(function(t){t.preventDefault();$("#short-url").text("Loading short url...");zerobin.getTinyURL(window.location.toString(),function(u){s.setText(u);$("#copy-success").hide();zerobin.message("success",'<a href="'+u+'">'+u+"</a>","Short url",true,r);$("#short-url").text("Get short url")})});$(".close").die().live("click",function(t){t.preventDefault();$(this).parent().fadeOut(r)});if(zerobin.isCode(q)>100){$("#paste-content").addClass("linenums");prettyPrint()}else{if(q.indexOf("data:image")!=0){zerobin.message("info","The paste did not seem to be code, so it was not colorized. <a id='force-coloration' href='#'>Force coloration</a>","",false,r)}}$("#paste-content").addClass("done");i.set("Done","100%");i.container.hide();n.prop("disabled",false);q=""},250)})}$(".paste-option select").live("change",function(){$(".paste-option select").val($(this).val())});$("#content").elastic();$("#content").live("keyup change",function(){if($("#content").height()<400){$(".paste-option.down").remove()}else{if($(".paste-option").length===1){$(".paste-option").clone().addClass("down").appendTo("form.well")}}});if(zerobin.support.localStorage){var m=$(".previous-pastes"),o=zerobin.getPreviousPastes();if(o.length){$.getScript("/static/js/vizhash.min.js").done(function(e,p){m.find(".item").remove();$.each(zerobin.getPreviousPastes(),function(s,u){var v=$('<li class="item"></li>').appendTo(m);var r=$("<a></a>").attr("href",u.link).text(u.prefix+u.displayDate).appendTo(v);if(vizhash.supportCanvas){var t=zerobin.getPasteId(u.link);var q=vizhash.canvasHash(t,24,24).canvas;r.prepend($(q).addClass("vhash"))}if(u.link.replace(/#[^#]+/,"")===window.location.pathname){v.addClass("active");r.click(function(){window.location=r.attr("href");window.location.reload()})}})})}}$(".btn-clone").click(function(p){p.preventDefault();$(".submit-form").show();$(".paste-form").hide();$("#content").val(zerobin.getPasteContent()).trigger("change")});$(".clone .btn-danger").click(function(p){p.preventDefault();$(".submit-form").hide();$(".paste-form").show()});if(zerobin.support.fileUpload){var d=$("#file-upload");var b=$(".btn-upload");try{b.val("Uploading...");b.prop("disabled",true);d.change(function(){zerobin.upload(this.files)})}catch(g){zerobin.message("error","Could no upload the file","Error");b.val("Upload File");b.prop("disabled",false)}b.prop("disabled",false);b.val("Upload File");d.mouseover(a($(this).css,"cursor","pointer"));$("#content").bind("dragenter",zerobin.ignoreDrag);$("#content").bind("drop",zerobin.handleDrop);$("#content").bind("dragover",zerobin.handleDragOver);$("#content").bind("dragleave",zerobin.handleDragLeave)}$(".close").live("click",function(p){p.preventDefault();$(this).parent().fadeOut()});$(".email-link").each(function(q,r){var t=$(this);var e=t.attr("title").replace("__AT__","@");var s=t.text().replace("__AT__","@");var p=$('<a href="mailto:'+e+'">'+s+"</a>");t.replaceWith(p)});$("#wrap-content").each(function(e,p){$(p).show()});if(zerobin.support.history&&zerobin.paste_not_found){var c=zerobin.getPasteId();var l=zerobin.getLocalStorageKeys();$.each(l,function(p,e){if(localStorage[e].indexOf(c)!==-1){localStorage.removeItem(e);return false}})}$("#force-coloration").live("click",function(p){p.preventDefault();$("#paste-content").addClass("linenums");$(this).die(p).text("Applying coloration");prettyPrint();$(this).remove()});var f="mailto:friend@example.com?body="+window.location;$("#email-link").attr("href",f)})})();